            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                        <!--begin::Title-->
                        <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0"> تعديل بيانات المستخدم </h1>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
...
<form id="kt_invoice_form" action="{{ route('users.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="card-body p-12">
                                    ...
                                    <div class="d-flex flex-column align-items-start flex-xxl-row">
                                        ...
                                        <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Enter invoice number">
                                            <span class="fs-2x fw-bold text-gray-800"> تحديث البيانات </span>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Top-->
                                    ...
                                    <div class="mb-0">
                                        <div class="row mb-5">
                                            ...
                                            <i class="ki-outline ki-triangle fs-3"></i> تعديل بيانات المستخدم </button>
                                        </div>
                                    </div>
                                    <!--end::Wrapper-->
                                </div>
                    ...
                    <div class="col-12 col-md-6">
<form id="kt_invoice_form" action="{{ route('users.updatePassword', $item->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-12">
                                    ...
                                    <div class="d-flex flex-column align-items-start flex-xxl-row">
                                        <!--begin::Input group-->
                                        <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Enter invoice number">
                                            <span class="fs-2x fw-bold text-gray-800"> تحديث كلمة المرور </span>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Top-->
                                    ...
                                    <div class="mt-10">
                                        <div class="row mb-5">
                                            <button type="submit" href="#" class="btn btn-primary w-100" id="kt_invoice_submit_button">
                                                <i class="ki-outline ki-triangle fs-3"></i> تحديث كلمة المرور
                                            </button>
                                        </div>
                                    </div>
                                    <!--end::Wrapper-->
