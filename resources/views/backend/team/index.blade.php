                ...
                <div class="card card-flush mb-5 mb-xl-10">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold text-gray-900"> جميع الموظفين </span>
                            <span class="text-gray-500 mt-1 fw-semibold fs-6"> يوجد {{ $published->count() }} موظف متاح علي الموقع و {{ $unpublished->count() }}  غير متاح  </span>
                        </h3>
                        <!--end::Title-->
                        <!--begin::Actions-->
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex flex-stack flex-wrap gap-4">
                                ...
                                <!--end::Status-->
                                <!--begin::Search-->
                                <a href="{{ route('team.create') }}" class="btn btn-light btn-sm"> اضافة موظف جديد ال فريق العمل </a>
                                <!--end::Search-->
                            </div>
                        </div>
                        <!--end::Actions-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-end pe-3 min-w-100px"> اسم الموظف </th>
                                    <th class="text-end pe-3 min-w-150px"> الوظيفة </th>
                            ...
                            <tbody class="fw-bold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <img src="{{ asset($item->image) }}" class="w-50px rounded-3" alt="">
                                    </td>
