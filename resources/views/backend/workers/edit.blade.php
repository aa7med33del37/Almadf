                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="row gx-10 mb-5">
                                            <div class="col-lg-12">
                                                ...
                                                <div>
                                                    <input type="text" class="form-control form-control-solid" placeholder="" name="name" value="{{ $worker->name }}"/>
                                                </div>
                                                @error('name')
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div>
                                                    <input type="number" class="form-control form-control-solid" placeholder="" min="18" max="50" value="25" name="age" value="{{ $worker->age }}" style="text-align: end"/>
                                                </div>
                                                @error('age')
                                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div>
                                                    <input type="number" class="form-control form-control-solid" placeholder="" min="0" max="50" value="5" name="experience" value="{{ $worker->experience }}" style="text-align: end"/>
                                                </div>
                                                @error('experience')
                                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <textarea name="description" class="form-control form-control-solid" rows="3" placeholder="وصف قصير للعامله"> {{ $worker->description }} </textarea>
                                            @error('description')
                                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-0">
                                            ...
                                            <textarea name="long_description" class="form-control form-control-solid" rows="3" placeholder="وصف طويل للعامله"> {{ $worker->long_description }} </textarea>
