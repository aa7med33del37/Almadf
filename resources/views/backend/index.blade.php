                            ...
                            <div class="card-body d-flex flex-column flex-center">
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="py-10 text-center">
                                        <img src="{{ asset('layouts/backend/assets/media/svg/illustrations/easy/2.svg') }}" class="theme-light-show w-200px" alt="" />
                                        <img src="{{ asset('layouts/backend/assets/media/svg/illustrations/easy/2-dark.svg') }}" class="theme-dark-show w-200px" alt="" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                                <!--end::Heading-->
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img src="{{ asset('layouts/backend/assets/media/stock/ecommerce/210.png') }}" class="w-50px" alt="" />
                                                </td>
                                                <td class="ps-0">
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="{{ asset('layouts/backend/assets/media/stock/ecommerce/215.png') }}" class="w-50px" alt="" />
                                                </td>
                                                <td class="ps-0">
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="{{ asset('layouts/backend/assets/media/stock/ecommerce/209.png') }}" class="w-50px" alt="" />
                                                </td>
                                                <td class="ps-0">
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="{{ asset('layouts/backend/assets/media/stock/ecommerce/214.png') }}" class="w-50px" alt="" />
                                                </td>
                                                <td class="ps-0">
