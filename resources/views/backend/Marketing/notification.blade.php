    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                <!--begin::Layout-->
                <form id="kt_invoice_form" action="{{ route('notification.store', $notification->id ?? '') }}" method="POST">
                    @csrf
                                ...
                                <div class="card-body p-12">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="row gx-10 mb-5">
                                            <div class="col-lg-12">
                                                <label class="form-label fs-6 fw-bold text-gray-700 mb-3"> نص الاعلان </label>
                                                <div>
                                                    <input type="text" class="form-control form-control-solid" placeholder="" name="notification_bar" value="{{ $notification->notification_bar ?? '' }}"/>
                                                </div>
                                                @error('notification_bar')
                                ...
                                <div class="card-body p-10">
                                    ...
                                    <div class="mb-8">
                                        ...
                                        <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack mb-5">
                                            ...
                                            <input class="form-check-input" type="checkbox" checked="checked" value="{{ $notification->status ?? '1' }}" name="status"/>
                                        </label>
                                        <!--end::Option-->
                                    </div>
                                    <!--end::Separator-->
