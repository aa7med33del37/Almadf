    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                <!--begin::Layout-->
                <form id="kt_invoice_form" action="{{ route('mainbanner.store', $data->id ?? '') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="card-body p-10">
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body text-center pt-0">
                                            ...
                                            <style>.mainbanner1-input { background-image: url({{ asset($data->image1 ?? '') }}) !important; } [data-bs-theme="dark"].image-input-placeholder { background-image: url($data->image1 ?? '')!important; }</style>
                                            <!--end::Image input placeholder-->
                                            <div class="image-input image-input-empty image-input-outline image-input-placeholder logo-input mb-3 mainbanner1-input" data-kt-image-input="true">
                                ...
                                <div class="card-body p-10">
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body text-center pt-0">
                                            <!--begin::Image input-->
                                            <!--begin::Image input placeholder-->
                                            <style>.mainbanner2-input { background-image: url({{ asset($data->image2 ?? '') }}) !important; } [data-bs-theme="dark"].image-input-placeholder { background-image: url($data->image2 ?? '')!important; }</style>
                                            <!--end::Image input placeholder-->
                                            <div class="image-input image-input-empty image-input-outline image-input-placeholder logo-input mb-3 mainbanner2-input" data-kt-image-input="true">
                                                <!--begin::Preview existing avatar-->
                                                <div class="image-input-wrapper w-150px h-150px"></div>
                                                <!--end::Preview existing avatar-->
                                                <!--begin::Label-->
                                ...
                                <div class="card-body p-10">
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body text-center pt-0">
                                            <!--begin::Image input-->
                                            <!--begin::Image input placeholder-->
                                            <style>.mainbanner3-input { background-image: url({{ asset($data->image3 ?? '') }}) !important; } [data-bs-theme="dark"].image-input-placeholder { background-image: url($data->image3 ?? '')!important; }</style>
                                            <!--end::Image input placeholder-->
                                            <div class="image-input image-input-empty image-input-outline image-input-placeholder logo-input mb-3 mainbanner3-input" data-kt-image-input="true">
                                                <!--begin::Preview existing avatar-->
                                                <div class="image-input-wrapper w-150px h-150px"></div>
                                                <!--end::Preview existing avatar-->
                                                <!--begin::Label-->
                                ...
                                <div class="card-body p-10">
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body text-center pt-0">
                                            <!--begin::Image input-->
                                            <!--begin::Image input placeholder-->
                                            <style>.mainbanner4-input-placeholder { background-image: url({{ asset($data->image4 ?? '') }}) !important; } [data-bs-theme="dark"].mainbanner4-input-placeholder { background-image: url($data->image4 ?? '')!important; }</style>
                                            <!--end::Image input placeholder-->
                                            <div class="image-input image-input-empty image-input-outline mainbanner4-input-placeholder logo-input mb-3 mainbanner-input" data-kt-image-input="true">
                                                <!--begin::Preview existing avatar-->
                                                <div class="image-input-wrapper w-150px h-150px"></div>
                                                <!--end::Preview existing avatar-->
                                                <!--begin::Label-->
