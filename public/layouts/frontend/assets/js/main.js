jQuery(function ($) {
	...
	$(".newsletter-form").ajaxChimp({
		url: "https://شهرة.us20.list-manage.com/subscribe/post?u=60e1ffe2e8a68ce1204cd39a5&amp;id=42d6d188d9", // Your url MailChimp
	...
	/*End "Home Demo - 4", "Home Demo - 5" & "Home Demo - 6" JS*/

}(jQuery));

// function to set a given theme/color-scheme
function setTheme(themeName) {
    localStorage.setItem('drove_rtl_theme', themeName);
    document.documentElement.className = themeName;
}
// function to toggle between light and dark theme
function toggleTheme() {
    if (localStorage.getItem('drove_rtl_theme') === 'theme-dark') {
